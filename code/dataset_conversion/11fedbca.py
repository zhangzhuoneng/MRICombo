...
def ProcessImageWithFixedSize(imImage, imLabel, save_path, name, target_spacing=[1.0, 1.0, 1.0],target_size=[128, 128, 128], mode='0000'):
    ...
    # 先进行前景裁剪
    cropped_img, cropped_lab = CropForeground(imImage, imLabel, context_size=[0, 0, 0]) # z, y, x
...
if __name__ == '__main__':
    src_path = '/data/zzn/UniMRINet/dataset/seg_orginal/cls/11FedBca/'
    mr_tgt_path = '/data/zzn/UniMRINet/dataset/MR_Dataset/11FedBca0/'
    ...
    for name in mr_name_list:
        ...
        ProcessImageWithFixedSize(img, lab, mr_tgt_path, name, target_size=[128, 128, 128], mode='0000')
        print(name, 'done')